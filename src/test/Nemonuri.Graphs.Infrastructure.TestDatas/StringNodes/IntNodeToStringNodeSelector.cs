...
<
    ValueNull, ValueNull, ValueNull, ImmutableList<StringNode>,
...
>
{
    ...
    public ValueNull AggregateOuterPrevious(scoped ref MutableContextRecord<ValueNull, ValueNull> mutableContext, ValueNull source, LabeledPhaseSnapshot<OuterPhaseLabel, OuterPhaseSnapshot<IntNode, IntNodeArrow, ValueNull, ImmutableList<StringNode>>> value)
    {
        return default;
    }

    public ValueNull AggregateInnerPrevious(scoped ref MutableContextRecord<ValueNull, ValueNull> mutableContext, ValueNull source, LabeledPhaseSnapshot<InnerPhaseLabel, InnerPhaseSnapshot<IntNode, IntNodeArrow, IntNodeArrow, IntNodeOutArrowSet, ValueNull, ImmutableList<StringNode>>> value)
    {
        return default;
    }
    ...
    public ImmutableList<StringNode> AggregateInnerPost(scoped ref MutableContextRecord<ValueNull, ValueNull> mutableContext, ImmutableList<StringNode> source, LabeledPhaseSnapshot<InnerPhaseLabel, InnerPhaseSnapshot<IntNode, IntNodeArrow, IntNodeArrow, IntNodeOutArrowSet, ValueNull, ImmutableList<StringNode>>> value)
    {
        //--- select value ---
    ...
    public ImmutableList<StringNode> AggregateOuterPost(scoped ref MutableContextRecord<ValueNull, ValueNull> mutableContext, ImmutableList<StringNode> source, LabeledPhaseSnapshot<OuterPhaseLabel, OuterPhaseSnapshot<IntNode, IntNodeArrow, ValueNull, ImmutableList<StringNode>>> value)
    {
