...
public ref struct AggregatorContext<TDescendants, TChildren, TChild, TGraph>
{
    ...
    public AggregatorContext(ref TDescendants descendantsScopeContext, ref TChildren childrenScopeContext, ref TChild childScopeContext, ref TGraph graphScopeContext)
    {
